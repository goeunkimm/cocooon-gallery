...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function Yh(){return new mr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Lf(),fragmentShader:`
		...
		`,blending:Ii,depthTest:!1,depthWrite:!1})}function qh(){return new mr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Lf(),fragmentShader:`
